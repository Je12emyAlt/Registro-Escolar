...
#Region "Agregar"
    Public Shared Function agregar_info_curso(id_curso As String, id_carrera As String, id_horario As String, nombre As String, id_profesor As String, descripcion As String,
        ...
        i = acceso_datos.agregar_info_curso(id_carrera, id_carrera, id_horario, nombre, id_profesor, descripcion, requisito, id_sede, costo, creditos)
        Return i
    End Function
#End Region
...
#Region "Modificar"
    Public Shared Function modificar_info_curso(id_curso As String, id_carrera As String, id_horario As String, nombre As String, id_profesor As String, descripcion As String,
        ...
        i = acceso_datos.modificar_info_curso(id_curso, id_curso, id_horario, nombre, id_profesor, descripcion, requisito, id_sede, costo, creditos)
        Return i
    End Function
#End Region
...
#Region "Borrar"
    Public Shared Function borrar_info_curso(id_curso As String, id_carrera As String) As Integer
        ...
        i = acceso_datos.borrar_info_curso(id_carrera, id_carrera)
        Return i
    End Function
#End Region
